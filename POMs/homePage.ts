...
constructor(page: Page) {
    ...
    this.changeLanguageButton = page.getByRole('banner').getByRole('button', { name: 'US - English ' });
    this.locationModal = page.getByLabel('choose your location');
    this.languageDropdown = page.locator('div').filter({ hasText: /^EnglishEspañol$/ }).getByRole('combobox');
